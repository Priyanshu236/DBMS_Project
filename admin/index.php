<?php	
	...
	{
		header("Location: http://localhost/dbmsproject/admin/login.php");
	...
	<div class="container topspace">
		<div class="text-center">
			...
			<?php
				...
				$query = "SELECT id, postTitle, description, post_date, author, catinfo FROM blog_posts ORDER BY id DESC";
			...
			//*********************************** category end ************************************************************
			                ...
			                echo '<td><i>'.date('jS M Y H:i:s', strtotime($row['post_date'])).'</td><td></i>'.$row['author'].'</td>';
			                ?>
