<?php
	...
	if (isset($_POST['addcat'])) 
	{
		...
		$catDesc = mysqli_real_escape_string($con,$catDesc);

		$query = "INSERT INTO blog_cats (catID, catTitle, catDesc) VALUES (NULL, '$catname', '$catDesc')";
	...
	<div class="container topspace">
		<div class="form-wrapper">
			<form class="" method="post" action="<?php $PHP_SELF ?>">
				...
				<div class="space">
					<label for="catdesc"><h2>Cat desc</h2></label>
					<input name="catdesc" placeholder="Category Desc" id="catdesc" class="form-control" required>
				</div>
